 ...
 */
final class Version20251202062606 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, workshop_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, age INT NOT NULL, phonenumber INT NOT NULL, email VARCHAR(255) NOT NULL, reservationtime DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_42C849551FDCE57C (workshop_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
